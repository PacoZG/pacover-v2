      ...
      <div className="w-full sm:w-11/12 lg:w-9/12 mx-auto px-4 space-y-16">
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li>
              <span className="font-semibold">src/components/:</span> Holds all
              reusable and self-contained components (e.g., Header, Footer,
              Skills).
            </li>
            <li>
              <span className="font-semibold">src/utils/:</span> Contains
              utility functions and assets, such as language translations (i18n)
              and SVG logos.
            </li>
            <li>
              <span className="font-semibold">src/assets/:</span> Stores static
          ...
          <div className="space-y-10">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-700 dark:text-gray-400">
                ...
                . Custom styles (e.g., <code>skill-style.css</code>) are defined
